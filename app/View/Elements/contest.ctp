...
<div class="alert alert-info"><button type="button" class="close" data-dismiss="alert">&times;</button><?php echo h(sprintf('%s %s', date('Y/m/d H:i:s', strtotime($notification['Notification']['created'])), $notification['Notification']['data']));?></div>
<?php endforeach; ?>
<div class="tabbable">
